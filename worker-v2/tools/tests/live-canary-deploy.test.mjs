...
test("generated config isolates every mutable Cloudflare identity and freezes spend", () => {
  ...
  assert.equal(config.vars.DEEPSEEK_INPUT_USD_PER_MTOK, "0.44");
  assert.equal(config.vars.DEEPSEEK_OUTPUT_USD_PER_MTOK, "1.32");
  ...
  assert.equal(config.vars.DEEPSEEK_FALLBACK_INPUT_USD_PER_MTOK, "1.32");
  assert.equal(config.vars.DEEPSEEK_FALLBACK_OUTPUT_USD_PER_MTOK, "3.96");
