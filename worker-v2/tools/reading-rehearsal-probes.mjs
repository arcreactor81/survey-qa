...
function envFor() {
  return {
    ...
    XAI_API_KEY: "k", DEEPSEEK_API_KEY: "k", GEMINI_API_KEY: "k",
    ...
    GROK_INPUT_USD_PER_MTOK: "2", GROK_CACHED_INPUT_USD_PER_MTOK: "0.5", GROK_OUTPUT_USD_PER_MTOK: "6",
    GROK_LONG_CONTEXT_THRESHOLD_TOKENS: "200000",
    GROK_LONG_CONTEXT_INPUT_USD_PER_MTOK: "4", GROK_LONG_CONTEXT_CACHED_INPUT_USD_PER_MTOK: "1",
    GROK_LONG_CONTEXT_OUTPUT_USD_PER_MTOK: "12",
    GROK_MAX_INPUT_USD_PER_MTOK: "4", GROK_MAX_OUTPUT_USD_PER_MTOK: "12",
    GEMINI_EXTRACTION_MODEL: "gemini-2.5-flash",
    GEMINI_INPUT_USD_PER_MTOK: "0.15", GEMINI_OUTPUT_USD_PER_MTOK: "3.5",
    GEMINI_MAX_TOTAL_USD: "10", GEMINI_REASONING_EFFORT: "medium",
