...
const EXPECTED_STATIC_VARS = Object.freeze({
  ...
  EXEC_BATCH_MAX_MS: "600000",
  EXEC_MAX_BATCHES: "200",
  EXEC_MAX_EXPLORATION: "0",
  EXEC_MAX_STEPS_PER_PATH: "80",
  EXEC_PER_CASE_TIMEOUT_MS: "540000", // v38+: raised from 45s after first real walk measured 52-95s healthy walks
  EXEC_WALK_TIMEOUT_MS: "600000",
