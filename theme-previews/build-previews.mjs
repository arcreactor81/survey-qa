...
const DIRECTIONS = [
  ...
  },
  {
    ...
    light: `--ink:#0F2422;--paper:#F1F6F5;--card:#FFFFFF;--accent:#0B7364;--accent-dark:#085C50;--ok:#156B3F;--bad:#BE3E2E;--slate:#4F6663;--border:#D8E2E0;--text:#14282A;--muted:#4F6663;--btn-text:#FFFFFF;--band-bg:#071012;--band-title:#FFFFFF;--band-text:#DCE7E5;--band-muted:#85999B;--band-soft:#B4C8C3;--band-link:#7CE8C9;--tint:#E5EEEC;--tint-soft:#F7FAF9;--code-bg:#08211E;--code-text:#C7E8DC;--input-bg:#FFFFFF;--input-border:#C5D3D0;--focus-ring:rgba(11,115,100,.45);--focus-soft:rgba(11,115,100,.16);--pulse:rgba(11,115,100,.35);--wait-bg:#F7EFD3;--wait-text:#7A5E10;--ok-bg:#DDF2E4;--bad-bg:#FBE9E6;--done-border:#B2DAC3;--done-bg:#EFF8F2;--err-bg:#FBECEA;--err-border:#EDCBC5;--err-text:#8F2A21;--shadow:0 1px 2px rgba(7,16,18,.05),0 10px 28px rgba(7,16,18,.07);`,
    dark: `--ink:#EDF5F3;--paper:#0B1416;--card:#101E21;--accent:#35D3AC;--accent-dark:#5FE0BF;--ok:#74D389;--bad:#F4695A;--slate:#8FA6A2;--border:#24363A;--text:#DCE7E5;--muted:#93A9A5;--btn-text:#062019;--band-bg:#060D0F;--band-title:#EDF5F3;--band-text:#DCE7E5;--band-muted:#7E9490;--band-soft:#B4C8C3;--band-link:#7CE8C9;--tint:#122023;--tint-soft:#101C1F;--code-bg:#07110F;--code-text:#B8E6D2;--input-bg:#0F1B1E;--input-border:#2E4247;--focus-ring:rgba(53,211,172,.55);--focus-soft:rgba(53,211,172,.2);--pulse:rgba(53,211,172,.38);--wait-bg:rgba(242,206,114,.13);--wait-text:#F2CE72;--ok-bg:rgba(116,211,137,.14);--bad-bg:rgba(244,105,90,.16);--done-border:#2C5B41;--done-bg:rgba(116,211,137,.1);--err-bg:rgba(244,105,90,.12);--err-border:rgba(244,105,90,.4);--err-text:#FFAFA4;--shadow:0 1px 2px rgba(0,0,0,.55),0 10px 28px rgba(0,0,0,.5);`,
  },
  {
